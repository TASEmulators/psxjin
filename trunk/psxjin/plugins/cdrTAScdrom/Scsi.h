...
#define MODE_PAGE_CDROM_PARAMETERS      0x0D // cdrom
...
typedef struct _CDVD_CAPABILITIES_PAGE {
	...
	// WARNING: The Microsoft version doesn't contained this last field,
	// and this structure was 2 bytes smaller than the SCSI standard !!!
	// Be careful to check it if you want to use an updated 'scsi.h' file.
...
//
// CD-ROM Parameters Page Format (0x0D)
//

// Inactivity timer multiplier values
#define INACTIVITY_TIMER_VENDOR_SPECIFIC 0x00
#define INACTIVITY_TIMER_125MS           0x01
#define INACTIVITY_TIMER_250MS           0x02
#define INACTIVITY_TIMER_500MS           0x03
#define INACTIVITY_TIMER_1S              0x04
#define INACTIVITY_TIMER_2S              0x05
#define INACTIVITY_TIMER_4S              0x06
#define INACTIVITY_TIMER_8S              0x07
#define INACTIVITY_TIMER_16S             0x08
#define INACTIVITY_TIMER_32S             0x09
#define INACTIVITY_TIMER_1MIN            0x0A
#define INACTIVITY_TIMER_2MIN            0x0B
#define INACTIVITY_TIMER_4MIN            0x0C
#define INACTIVITY_TIMER_8MIN            0x0D
#define INACTIVITY_TIMER_16MIN           0x0E
#define INACTIVITY_TIMER_32MIN           0x0F

typedef struct _CDROM_PARAMETERS_PAGE {
    UCHAR PageCode : 6;     // 0x0D
    UCHAR Reserved : 1;
    UCHAR PSBit : 1;
    ...
    UCHAR InactivityTimerMultiplier : 4;   // Default 0
    UCHAR Reserved3 : 4;

    UCHAR NumberOfSUnitsPerMUnits[2];      // (MSB,LSB) Always 60
    UCHAR NumberOfFUnitsPerSUnits[2];      // (MSB,LSB) Always 75
} CDROM_PARAMETERS_PAGE, *PCDROM_PARAMETERS_PAGE;
