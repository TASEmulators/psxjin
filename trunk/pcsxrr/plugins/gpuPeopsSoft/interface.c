...
create_Config (void)
{
	...
	GtkWidget *GtkCheckButton_SSSPSXLimit;
	GtkWidget *vbox11;
	...
	GtkCheckButton_SSSPSXLimit = gtk_check_button_new_with_label ("Use SSSPSX Frame limit");
	gtk_widget_ref (GtkCheckButton_SSSPSXLimit);
	gtk_object_set_data_full (GTK_OBJECT (Config), "GtkCheckButton_SSSPSXLimit", GtkCheckButton_SSSPSXLimit,
	                          (GtkDestroyNotify) gtk_widget_unref);
	gtk_widget_show (GtkCheckButton_SSSPSXLimit);
	gtk_box_pack_start (GTK_BOX (vbox10), GtkCheckButton_SSSPSXLimit, FALSE, FALSE, 0);
